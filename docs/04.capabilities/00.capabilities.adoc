...
This is the main function in charge of building a <<procservice,processing Service>> from an Application Package.
...
The submission of a job starts a process instantiation and execution of an application. Basically, the ADES executes the <<procservice,Service Component>> built during the <<Application Deployment to Web Processing Service,application deployment>>.
