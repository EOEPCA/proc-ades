...
The submission of a job starts a process instantiation and execution of an application. Basically, the ADES execute the <<appservice,Service Component>> built during the <<Application Deployment to Web Processing Service,application deployment>>.
...
// .ADES Workflow Execution Activity Diagram
// [plantuml, workflowexec, png] 
// ....
// include::../include/workflowexec.wsd[]
// ....
