...
All software and their dependecies are described in the next sections
...
The workflow executor is the component in charge of the scheduling ang tbe the management of the processing jobs.
...
.ADES Workflow Executor Component Diagram
