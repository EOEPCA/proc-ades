...
The Service component is in charge of orchestrating the application execution when the service in invoked by a <<Execute Service as Job,job submission>> from the Web Processing Service layer.
